    ...
    <div className="page-container">
      ...
      <section className="space-y-4">
        <div className="flex flex-col gap-1">
          <h1 className="text-4xl font-extrabold tracking-tight">Component Showcase</h1>
          <p className="text-muted-foreground text-lg">A comprehensive reference for all NIDS UI elements, variants, and states.</p>
        </div>
        <Separator />
      </section>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <Card className="shadow-lg border-primary/5">
            <CardHeader>
              ...
              <CardDescription>Inline dual-ring animation for tables and cards.</CardDescription>
            </CardHeader>
            <CardContent className="border-2 border-dashed rounded-xl m-6 mt-0 bg-muted/20 min-h-[200px] flex items-center justify-center">
          ...
          <Card className="shadow-lg border-primary/5">
            <CardHeader>
              ...
              <CardDescription>High-impact overlay with backdrop blur.</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-6 justify-center min-h-[200px]">
              <Button onClick={triggerFullLoader} variant="outline" size="lg" className="w-full">
                Trigger Full Page Loader (3s)
              </Button>
              <div className="space-y-2">
                <p className="text-xs font-medium uppercase text-muted-foreground text-center">Button Internal Loader</p>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <Card className="md:col-span-2 shadow-lg border-primary/5">
            <CardHeader>
              ...
              <CardDescription>States, variants, and group focus patterns.</CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-muted/50 transition-colors">
                  ...
                  <Label htmlFor="perm-view" className="cursor-pointer">View Permission</Label>
                </div>
                <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-muted/50 transition-colors">
                  <Checkbox id="perm-edit" />
                  <Label htmlFor="perm-edit" className="cursor-pointer">Edit Permission</Label>
                </div>
                <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-muted/50 transition-colors opacity-50">
                  <Checkbox id="perm-delete" disabled />
                  <Label htmlFor="perm-delete" className="cursor-pointer">Delete (Disabled)</Label>
                </div>
              </div>
              <Separator />
              <div className="space-y-2">
      ...
      <section className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Floating, non-disruptive notifications that vanish over time.</CardDescription>
          </CardHeader>
          <CardContent className="flex flex-wrap gap-4">
            ...
            <Button onClick={() => triggerToast('warning')} variant="outline" className="border-warning text-warning hover:bg-warning/10">
          ...
          <Card className="shadow-lg border-primary/5">
            ...
            <CardContent className="flex items-center justify-around py-6">
              ...
              <div className="flex -space-x-4">
                ...
                <Avatar className="border-2 border-background">
                  <AvatarFallback className="bg-amber-500 text-white">AS</AvatarFallback>
                </Avatar>
                <Avatar className="border-2 border-background">
                  <AvatarFallback className="bg-primary text-white">+5</AvatarFallback>
                </Avatar>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="flex items-center justify-center py-6">
              <Dialog>
                <DialogTrigger asChild>
                  <Button variant="outline" className="w-full">Open Demo Dialog</Button>
                </DialogTrigger>
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>System Confirmation</DialogTitle>
                    <DialogDescription>
                      This is a standard dialog used for critical actions and focused forms.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="py-4">
                    <p className="text-sm text-muted-foreground">Are you sure you want to proceed with this operation? This action cannot be undone.</p>
                  </div>
                  <DialogFooter>
            ...
            <CardContent className="flex items-center justify-center py-6">
              <Sheet>
                <SheetTrigger asChild>
                  <Button variant="secondary" className="w-full">Open Sidebar Sheet</Button>
                </SheetTrigger>
                <SheetContent>
                  <SheetHeader>
      ...
      <section className="space-y-6">
        ...
        <Card className="shadow-lg border-primary/5">
          <CardHeader>
            ...
            <CardDescription>Demonstrating multi-type support and rich contact details.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="rounded-xl border bg-muted/30 p-4 space-y-6">
                ...
                <div className="space-y-1">
                  <h3 className="text-xl font-bold flex items-center gap-2">
                    ...
                    <div className="flex gap-1">
                      <Badge variant="outline" className="text-[10px] bg-primary/10 text-primary border-primary/20">Supplier</Badge>
                      <Badge variant="outline" className="text-[10px] bg-primary/10 text-primary border-primary/20">Transporter</Badge>
                    </div>
                  </h3>
                  <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                    <span className="flex items-center gap-1"><User className="size-3" /> Budi Santoso</span>
                    <span className="flex items-center gap-1"><Mail className="size-3" /> logistics@gl-nusantara.co.id</span>
                    <span className="flex items-center gap-1"><Phone className="size-3" /> +62 21 555-8888</span>
                  </div>
                </div>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="p-3 rounded-lg bg-background border space-y-1">
                  ...
                  <p className="text-sm font-medium">Jakarta Selatan, DKI Jakarta</p>
                </div>
                <div className="p-3 rounded-lg bg-background border space-y-1 md:col-span-2">
                  <p className="text-[10px] uppercase font-bold text-muted-foreground flex items-center gap-1">
                    <Info className="size-3" /> Other Info
                  </p>
                  <p className="text-sm font-medium">Key transporter for East Java routes. Preferred bulk oil supplier.</p>
                </div>
              </div>
            </div>
          </CardContent>
