...
async function POST(request) {
    try {
        const { email, full_name, username, role, redirectTo } = await request.json();
        ...
        if (error) {
            console.error("API: Invite error details:", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__27fb8c1a._.js.map