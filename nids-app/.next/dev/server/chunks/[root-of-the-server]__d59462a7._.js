...
async function GET(request) {
    ...
    if (code) {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServerSideClient"])();
        const { error } = await supabase.auth.exchangeCodeForSession(code);
        if (!error) {
            const isLocalEnv = ("TURBOPACK compile-time value", "development") === 'development';
            if ("TURBOPACK compile-time truthy", 1) {
                // we can be sure that origin is a safe host to redirect to
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d59462a7._.js.map