...
"[project]/nids-app/app/api/auth/verify-token/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data: profile, error: fetchError } = await __TURBOPACK__imported__module__$5b$project$5d2f$nids$2d$app$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('profiles').select('id, email, setup_token_expires').eq('setup_token', token).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a93bea6._.js.map