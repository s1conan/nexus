...
function LoginPage() {
    ...
    const handleForgotSubmit = async (e)=>{
        ...
        try {
            ...
            if (result.error) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$nids$2d$app$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(dict.MSG_RESET_LINK_SENT, {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { data: profileRecord, error: lookupError } = await supabase.from('profiles').select('id, email, is_active').or(`username.eq.${input},email.eq.${input}`).maybeSingle();
            if (lookupError) {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$nids$2d$app$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$nids$2d$app$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                        className: "text-3xl font-bold tracking-tight text-foreground drop-shadow-md text-shadow-stroke text-shadow-gray-200",
...
//# sourceMappingURL=nids-app_app_page_tsx_61ad21a5._.js.map