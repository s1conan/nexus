...
function LoginPage() {
    ...
    const [forgotStatus, setForgotStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$nids$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const handleForgotSubmit = async (e)=>{
        ...
        try {
            ...
            if (error) {
                ...
                setForgotStatus({
                    type: 'success',
                    message: dict.MSG_RESET_SENT || "If an account exists with this email, you will receive a password reset link shortly."
                });
                setForgotEmail("");
            }
        } catch (err) {
...
_s(LoginPage, "zo7E1gu+x3s4eemDsECEl1qSuWc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$nids$2d$app$2f$components$2f$dictionary$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDictionary"],
...
//# sourceMappingURL=nids-app_fce1f96c._.js.map